...
import { privateSaga, updateUserData } from './userSaga';
...
import { resetPasswordSaga, resetPasswordConfirmationSaga } from './resetPasswordSagas';
...
function * rootSaga () {
  ...
  yield takeLatest(ACTION.RESET_PASSWORD_CONFIRM_REQUEST, resetPasswordConfirmationSaga);
}
