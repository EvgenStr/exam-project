...
import styles from './LeftFigure.module.sass';
    ...
    >
      ...
      >
        <g>
          ...
          <path
            className={cx(styles.shapes80, 'fill-info')}
          ...
          ></path>
          <path
            className={cx(styles.shapes81, 'fill-warning')}
            clipPath='url(#abstractShapesID8_2)'
          ...
          ></path>
          <circle
            className={cx(styles.shapes82, 'fill-none stroke-info')}
            strokeWidth='3'
            strokeMiterlimit='10'
            clipPath='url(#abstractShapesID8_2)'
            cx='193.8'
