...
import styles from './BannerImage.module.sass';
  ...
  return (
    <div className='d-none d-lg-block'>
      <figure>
        ...
        >
          <path
            className={cx(styles.appUser1, 'fill-gray-300')}
            opacity='.3'
          ...
          ></path>
          <path
            className={cx(styles.appUser1, 'fill-white')}
          ...
          ></path>
          <path
            className={cx(styles.appUser5, 'fill-none stroke-dark')}
            strokeWidth='2.5'
            strokeLinecap='round'
          ...
          ></circle>
          <path
            className={cx(styles.appUser2, 'fill-white stroke-dark')}
            strokeWidth='2.5'
            strokeMiterlimit='10'
          ...
          ></path>
          <path
            className={cx(styles.appUser2, 'fill-none stroke-dark')}
            strokeWidth='2.5'
            strokeLinecap='round'
            strokeMiterlimit='10'
          ...
          ></path>
          <circle
            className={cx(styles.appUser6, 'fill-none stroke-gray-300')}
            strokeWidth='13'
            strokeMiterlimit='10'
            cx='260.1'
            cy='53.5'
